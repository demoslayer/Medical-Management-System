...
{
	string data;
	ifstream read("C:\\Users\\byas\\Desktop\\bills\\txt_data\\data.txt");
...
{
	ofstream write("C:\\Users\\byas\\Desktop\\bills\\txt_data\\data.txt", std::ios_base::app);
...
void hospital ::remove_data()
{
	...
	get_id();
	ofstream writet("C:\\Users\\byas\\Desktop\\bills\\txt_data\\temp.txt");
	ifstream read("C:\\Users\\byas\\Desktop\\bills\\txt_data\\data.txt");
	while (getline(read, data))
	{
		// cout<<data;
	...
	ofstream write("C:\\Users\\byas\\Desktop\\bills\\txt_data\\data.txt");
	ifstream readt("C:\\Users\\byas\\Desktop\\bills\\txt_data\\temp.txt");
...
void hospital ::modify_data()
{
	...
	readt.close();
	write.close();
	remove("C:\\Users\\byas\\Desktop\\bills\\txt_data\\data.txt");
}
